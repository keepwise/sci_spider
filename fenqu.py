...
class fenqu_gui(object):
    ...
    def begin_fenqu(self):
        ...
        while i<df_da.shape[0]:
            ...
            hdr_cells[0].text = str(title)
            hdr_cells[1].text = str(issn)
            hdr_cells[2].text = str(dalei)
            hdr_cells[3].text = str(dafenqu)
            hdr_cells[4].text = str(datop)
        ...
        while i < df_xiao.shape[0]:
            ...
            hdr_cells[0].text = str(title)
            hdr_cells[1].text = str(issn)
            hdr_cells[2].text = str(xiaolei)
            hdr_cells[3].text = str(xiaofenqu)
            hdr_cells[4].text = str(xiaocn)
